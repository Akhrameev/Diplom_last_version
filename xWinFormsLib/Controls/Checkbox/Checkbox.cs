...
namespace xWinFormsLib
{
    public class Checkbox: Control
    {
        ...
        public Checkbox(string name, Vector2 position, string text, bool bChecked)
            : base(name, position)
        {
            this.Text = text;
        ...
        public override void Initialize(Microsoft.Xna.Framework.Content.ContentManager content, GraphicsDevice graphics)
        {
            ...
            texture[0] = Texture2D.FromFile(graphics, @"content\textures\controls\checkbox\checked.png");
            texture[1] = Texture2D.FromFile(graphics, @"content\textures\controls\checkbox\unchecked.png");
